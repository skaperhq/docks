...
export function RequestTabStrip({
  ...
  return (
    <div className="flex h-10 shrink-0 items-center border-b border-border bg-card text-muted-foreground">
      ...
      >
        {operations.map((apiOperation, index) => {
          const duplicateNumber = operations
            .slice(0, index + 1)
            .filter(
              (operation) =>
                operation.method === apiOperation.method &&
                operation.displayPath === apiOperation.displayPath
            ).length
          const displayPath = `${apiOperation.displayPath}${
          ...
          return (
            ...
            >
              <Button
                ...
                aria-label={`Open ${displayPath} tab`}
              ...
              >
                ...
                <span className="truncate text-[12px]">{displayPath}</span>
              </Button>
              ...
              <Button
                ...
                aria-label={`Close ${displayPath} tab`}
